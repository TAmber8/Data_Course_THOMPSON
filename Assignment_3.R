...
?class
class(dat$Petal.Length) #numerical values
...
#create object iris_chr
#make iris_chr a data.fram
#in the data frame, apply iris dataset as character data
...
iris_chr
str(iris_chr) #check classes of each column
